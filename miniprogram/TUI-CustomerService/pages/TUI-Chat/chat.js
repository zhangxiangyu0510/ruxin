...
Page({
  ...
  onLoad(options) {
    ...
    //     productNo:options.productNo||'20009876254',
    //     show:true
    //   }
    console.log('options====',options);
    if(options&&options.shareParams){
        let transOptionsParams=Object.assign({show:true},JSON.parse(decodeURIComponent(options.shareParams)));
        console.log('transOptionsParams====',transOptionsParams);
          this.setData({
