...
Component({
  ...
  methods: {
    ...
    getShopImages() {
      ...
      // 头像
      let _shopInfo = wx.getStorageSync('shopInfo')
      let _avatar = _shopInfo.partnerProfile.avatar || canvasApp.globalData.imageUrl + '/icons/accountPictures.png'

      let _level = wx.getStorageSync('levelImg')
      this.setData({
